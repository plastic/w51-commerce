                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="mb-1 col-12">
                                    ...
                                    <input type="text" class="form-control" name="tx_produto" placeholder="Nome"
                                        maxlength="250"  value="{{ old('tx_produto') }}" required />
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mt-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="tx_url_video" placeholder="Ex. https://www.youtube.com/watch?v=000" value="{{ old('tx_url_video') }}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row prices">
                                ...
                                <div class="  col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="vl_preco_custo" value="{{ old('vl_preco_custo') }}">
                                    </div>
                                </div>
                                <div class="  col-md-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">R$</span>
                                        <input type="text" class="form-control" name="vl_preco_de" value="{{ old('vl_preco_de') }}">
                                    </div>
                                </div>
                                <div class=" col-md-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">R$</span>
                                        <input type="text" class="form-control" name="vl_preco_por" value="{{ old('vl_preco_por') }}">
                                    </div>
                                </div>
                            ...
                            <div class="row stock">
                                ...
                                <div class="  col-md-2 qnt">
                                    ...
                                    <input type="text" class="form-control" name="nr_quantidade" value="{{ old('nr_quantidade') }}">
                                </div>
                                ...
                                <div class=" col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="tx_isbn_ean" value="{{ old('tx_isbn_ean') }}">
                                </div>
                            ...
                            <div class="row dimensoes">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="nr_peso" value="{{ old('nr_peso') }}">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="nr_altura" value="{{ old('nr_altura') }}">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="nr_largura" value="{{ old('nr_largura') }}">
                                        <span class="input-group-text">cm</span>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="nr_profundidade" value="{{ old('nr_profundidade') }}">
                                        <span class="input-group-text">cm</span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-12">
                                    <select class="select2 form-select select-dep-cat" name="categorias[]" id="select2-multiple" multiple
                                        required>
                                    </select>
                                </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="tx_title" value="{{ old('tx_title') }}">
                                </div>
                                <div class="col-12 mt-2">
